...
from ... import config
from .utils import (SmoothCrossEntropyLoss, draw_shadow, judge_mask_type,
                    load_mask, shadow_edge_blur)

with open(os.path.join(config.Shadow_ROOT, "params.json"), 'r') as configx:
    params = json.load(configx)
