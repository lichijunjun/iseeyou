...
from src.attacks.load import load_benchmark, load_adv_samples, load_dataset,load_normal_samples
...
parser.add_argument("--std", action='store_true', help="standard deviation flag")
...
for atk_type, atk_db in benchmark_list:
    ...
    dataset = load_normal_samples(atk_type, atk_db, args)
    ...
    torch.save(data_list, '/mnt/data/approx-killer/approx-killer/trash/advlb_cst_mean_std_6.pth')
'''
